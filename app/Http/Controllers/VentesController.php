...
class VentesController extends Controller
{
    ...
    public function getAmountsPerDays($debut, $fin)
    {
        ...
        while ($courant <=  $dernier) {
            ...
            $amountDays[] = ['days' => date('d F', $courant), 'day' => date('d', $courant), 'year' => date('Y', $courant), 'month' => date('m', $courant), 'hour' => date('H', $courant), 'minute' => date('i', $courant), 'second' => date('s', $courant), 'payment_amount' => $payment_amount == [] ? 0 : $payment_amount];
