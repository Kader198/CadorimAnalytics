...
class Cadorim_analytics extends Controller
{
    public function index(){
        ...
        $try = DB::table('mytable')->select('updated_at')->whereBetween('updated_at',[]);
        ...
        dd($try);
        // return view('cadorim.index', compact('Clients','numOfOperation','sumOfeachAmount','venteMoyen','arrayOfDay'));
    }
